...
(function () {
  ...
  function setupSiteSearch(closeMobileMenu) {
    ...
    var entries = [
      ...
      { category: 'Service', title: 'Residential Internet Ã¢â‚¬â€ iBlaZe (DOCSIS)', description: 'Cable internet shared through existing cable TV infrastructure. Available in Supercharged and Turbocharged tiers.', href: 'cablelink_plans.html?line=iblaze#bundle-groups', keywords: 'iblaze docsis residential internet cable shared supercharged turbocharged' },
      { category: 'Service', title: 'Residential Internet Ã¢â‚¬â€ FiberLink (FTTH)', description: 'Dedicated fiber-optic cable direct to your home. Available in Supercharged and Turbocharged tiers.', href: 'cablelink_plans.html?line=fiberlink#bundle-groups', keywords: 'fiberlink ftth fiber to the home residential internet dedicated supercharged turbocharged' },
      { category: 'Service', title: 'Cable TV Ã¢â‚¬â€ Basic 495, Basic Lite, Basic Plus', description: 'Cable TV packages for Digitally Activated areas: Basic 495 (65 ch), Basic Lite (53 ch), Basic Plus (126 ch).', href: 'cablelink_plans.html?filter=cable#bundle-groups', keywords: 'cable tv basic 495 65 channels basic lite 53 basic plus 126 digitally activated' },
      { category: 'Service', title: 'Bundled Plans Ã¢â‚¬â€ Supercharged & Turbocharged', description: 'Supercharged bundles Internet + Basic Plus. Turbocharged bundles Internet + Basic Lite.', href: 'cablelink_plans.html#bundle-groups', keywords: 'bundle bundled plans supercharged turbocharged internet cable combo basic plus basic lite' },
      { category: 'Service', title: 'Enterprise Services', description: 'Business and enterprise service enquiries Ã¢â‚¬â€ contact Cablelink to discuss requirements and availability.', href: 'cablelink_contact.html', keywords: 'enterprise business commercial corporate service enquiry' },
      ...
      { category: 'Plan', title: 'Supercharged iBlaZe@Home Ã¢â‚¬â€ from Ã¢â€šÂ±588/mo', description: 'DOCSIS cable internet + Basic Plus (126 channels). Tiers: 20, 30, 35, 50, 88, 120 Mbps.', href: 'cablelink_plans.html?filter=supercharged&line=iblaze#bundle-groups', keywords: 'supercharged iblaze docsis 20mbps 30mbps 35mbps 50mbps 88mbps 120mbps 588 888 999 1088 1388 1699 basic plus 126 channels' },
      { category: 'Plan', title: 'Supercharged FiberLink@Home Ã¢â‚¬â€ from Ã¢â€šÂ±888/mo', description: 'FTTH fiber + Basic Plus (126 channels). Tiers: 50, 75, 88, 188, 300 Mbps.', href: 'cablelink_plans.html?filter=supercharged&line=fiberlink#bundle-groups', keywords: 'supercharged fiberlink fiber ftth 50mbps 75mbps 88mbps 188mbps 300mbps 888 999 1088 1388 1699 basic plus 126 channels' },
      /* Turbocharged = Internet + Basic Lite (53 ch) */
      { category: 'Plan', title: 'Turbocharged iBlaZe@Home Ã¢â‚¬â€ from Ã¢â€šÂ±599/mo', description: 'DOCSIS cable internet + Basic Lite (53 channels). Tiers: 30, 50, 100 Mbps.', href: 'cablelink_plans.html?filter=turbocharged&line=iblaze#bundle-groups', keywords: 'turbocharged iblaze docsis 30mbps 50mbps 100mbps 599 999 1499 basic lite 53 channels budget' },
      { category: 'Plan', title: 'Turbocharged FiberLink@Home Ã¢â‚¬â€ from Ã¢â€šÂ±599/mo', description: 'FTTH fiber + Basic Lite (53 channels). Tiers: 50, 200, 300 Mbps.', href: 'cablelink_plans.html?filter=turbocharged&line=fiberlink#bundle-groups', keywords: 'turbocharged fiberlink fiber ftth 50mbps 200mbps 300mbps 599 999 1299 basic lite 53 channels gigabit budget' },
      /* Tier-only combos */
      { category: 'Plan', title: 'All Supercharged Plans Ã¢â‚¬â€ iBlaZe & FiberLink', description: 'Internet + Basic Plus (126 ch). iBlaZe DOCSIS from Ã¢â€šÂ±588 and FiberLink FTTH from Ã¢â€šÂ±888.', href: 'cablelink_plans.html?filter=supercharged#bundle-groups', keywords: 'supercharged all plans iblaze fiberlink docsis fiber ftth basic plus 126 bundle' },
      { category: 'Plan', title: 'All Turbocharged Plans Ã¢â‚¬â€ iBlaZe & FiberLink', description: 'Internet + Basic Lite (53 ch). iBlaZe DOCSIS from Ã¢â€šÂ±599 and FiberLink FTTH from Ã¢â€šÂ±599.', href: 'cablelink_plans.html?filter=turbocharged#bundle-groups', keywords: 'turbocharged all plans iblaze fiberlink docsis fiber ftth basic lite 53 bundle budget' },
      /* Line-only combos */
      { category: 'Plan', title: 'All iBlaZe Plans Ã¢â‚¬â€ Supercharged & Turbocharged', description: 'DOCSIS cable internet plans. Supercharged (Basic Plus) from Ã¢â€šÂ±588, Turbocharged (Basic Lite) from Ã¢â€šÂ±599.', href: 'cablelink_plans.html?line=iblaze#bundle-groups', keywords: 'iblaze docsis all plans supercharged turbocharged cable internet 20 30 35 50 88 100 120 mbps' },
      { category: 'Plan', title: 'All FiberLink Plans Ã¢â‚¬â€ Supercharged & Turbocharged', description: 'FTTH fiber-to-the-home plans. Supercharged (Basic Plus) from Ã¢â€šÂ±888, Turbocharged (Basic Lite) from Ã¢â€šÂ±599.', href: 'cablelink_plans.html?line=fiberlink#bundle-groups', keywords: 'fiberlink fiber ftth all plans supercharged turbocharged 50 75 88 188 200 300 mbps' },
      /* Cable TV */
      { category: 'Plan', title: 'Basic Lite Ã¢â‚¬â€ 53 Live Channels', description: 'Entry-level cable TV for Digitally Activated areas. 53 live channels. Available standalone or as Turbocharged bundle.', href: 'cablelink_plans.html?filter=cable#bundle-groups', keywords: 'basic lite cable tv 53 channels standalone subscription digitally activated turbocharged' },
      { category: 'Plan', title: 'Basic 495 Ã¢â‚¬â€ 65 Live Channels', description: 'Cable TV for Digitally Activated areas. 65 live channels.', href: 'cablelink_plans.html?filter=cable#bundle-groups', keywords: 'basic 495 cable tv 65 channels standalone subscription digitally activated' },
      { category: 'Plan', title: 'Basic Plus Ã¢â‚¬â€ 126 Live Channels', description: 'Full cable TV for Digitally Activated areas. 126 live channels. Available standalone or as Supercharged bundle.', href: 'cablelink_plans.html?filter=cable#bundle-groups', keywords: 'basic plus cable tv 126 channels standalone subscription digitally activated supercharged' },
      ...
      { category: 'Promo', title: "Supercharged iBlaZe@Home Valentine's Day", description: 'No lag, just love Ã¢â‚¬â€ supercharged DOCSIS internet bundled with free cable TV this Valentine season.', href: 'cablelink_promos.html', keywords: 'promo supercharged iblaze valentines free cable tv internet bundle offer' },
      { category: 'Promo', title: 'Supercharge FiberLink@Home Valentines Day', description: 'Up to 1 Gbps fiber speed plus FREE Basic Plus cable TV Ã¢â‚¬â€ ideal for movie nights and video calls.', href: 'cablelink_promos.html', keywords: 'promo supercharged fiberlink fiber valentines 1gbps free basic plus internet bundle offer' },

      /* Ã¢â€â‚¬Ã¢â€â‚¬ FAQ Ã¢â‚¬â€ SUBSCRIBER: SALES Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
      { category: 'FAQ', title: 'Can I upgrade my cable or internet plan?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-0', keywords: 'upgrade plan cable internet subscriber sales' },
      { category: 'FAQ', title: 'Can I downgrade my plan?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-1', keywords: 'downgrade plan subscriber sales' },
      { category: 'FAQ', title: 'How do I know which plan is best for me?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-2', keywords: 'best plan choose subscriber sales recommendation' },
      { category: 'FAQ', title: 'Can I add premium channels or add-on services?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-3', keywords: 'premium channels add-on services subscriber sales' },
      { category: 'FAQ', title: 'How long does it take to activate add-on services?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-4', keywords: 'activate add-on activation time subscriber sales' },
      { category: 'FAQ', title: 'Am I eligible for subscriber promotions?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-5', keywords: 'eligible subscriber promotions promo deals sales' },
      { category: 'FAQ', title: 'How do I request a plan change or add-on service?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-7', keywords: 'request plan change add-on subscriber sales' },
      { category: 'FAQ', title: 'Are there fees for changing plans?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-8', keywords: 'fees changing plans subscriber sales' },
      { category: 'FAQ', title: 'Can I switch to a bundled cable and internet plan?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-10', keywords: 'switch bundle cable internet plan subscriber sales' },
      { category: 'FAQ', title: 'Will my contract reset if I change my plan?', description: 'Subscriber Ã¢â‚¬â€ Sales related concerns.', href: 'cablelink_billing_faq.html#subs-sales-related-concerns-question-11', keywords: 'contract reset plan change subscriber sales' },

      /* Ã¢â€â‚¬Ã¢â€â‚¬ FAQ Ã¢â‚¬â€ SUBSCRIBER: BILLING Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
      { category: 'FAQ', title: 'When is my monthly bill due?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-0', keywords: 'monthly bill due date billing subscriber' },
      { category: 'FAQ', title: 'How can I get a copy of my billing statement?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-1', keywords: 'billing statement copy invoice subscriber' },
      { category: 'FAQ', title: 'What is a prorated charge?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-2', keywords: 'prorated charge billing subscriber' },
      { category: 'FAQ', title: 'What payment methods are accepted?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-3', keywords: 'payment methods accepted billing subscriber' },
      { category: 'FAQ', title: 'How long does it take for my payment to be posted?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-4', keywords: 'payment posted billing posting time subscriber' },
      { category: 'FAQ', title: 'What should I do if my payment is not yet posted?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-5', keywords: 'payment not posted billing subscriber' },
      { category: 'FAQ', title: 'What happens if I miss my due date?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-6', keywords: 'miss due date late payment billing subscriber' },
      { category: 'FAQ', title: 'How can I avoid service interruption?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-7', keywords: 'avoid service interruption disconnection billing subscriber' },
      { category: 'FAQ', title: 'Can I dispute a billing charge?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-8', keywords: 'dispute billing charge subscriber' },
      { category: 'FAQ', title: 'Will I receive a refund if there is a billing error?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-9', keywords: 'refund billing error subscriber' },
      { category: 'FAQ', title: 'Can I change my billing cycle or due date?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-10', keywords: 'change billing cycle due date subscriber' },
      { category: 'FAQ', title: 'What information should I prepare when contacting billing support?', description: 'Subscriber Ã¢â‚¬â€ Billing related concerns.', href: 'cablelink_billing_faq.html#subs-billing-related-concerns-question-12', keywords: 'billing support information prepare contact subscriber' },

      /* Ã¢â€â‚¬Ã¢â€â‚¬ FAQ Ã¢â‚¬â€ SUBSCRIBER: SERVICE Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
      { category: 'FAQ', title: 'What should I do if my internet connection is slow?', description: 'Subscriber Ã¢â‚¬â€ Service related concerns.', href: 'cablelink_billing_faq.html#subs-service-related-concerns-question-0', keywords: 'slow internet connection troubleshoot service subscriber' },
      { category: 'FAQ', title: 'What should I do if I have no internet or cable connection?', description: 'Subscriber Ã¢â‚¬â€ Service related concerns.', href: 'cablelink_billing_faq.html#subs-service-related-concerns-question-1', keywords: 'no internet no cable connection outage service subscriber' },

      /* Ã¢â€â‚¬Ã¢â€â‚¬ FAQ Ã¢â‚¬â€ NON-SUBSCRIBER: AVAILABILITY Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
      { category: 'FAQ', title: 'Is your cable and internet service available in my area?', description: 'Non-Subscriber Ã¢â‚¬â€ Service availability.', href: 'cablelink_billing_faq.html#non_subs-service-availability-question-0', keywords: 'service available area coverage non-subscriber availability' },
      { category: 'FAQ', title: 'Do you offer services for both residential and business customers?', description: 'Non-Subscriber Ã¢â‚¬â€ Service availability.', href: 'cablelink_billing_faq.html#non_subs-service-availability-question-1', keywords: 'residential business customers service availability non-subscriber' },

      /* Ã¢â€â‚¬Ã¢â€â‚¬ FAQ Ã¢â‚¬â€ NON-SUBSCRIBER: PLANS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
      { category: 'FAQ', title: 'What cable and internet plans do you offer?', description: 'Non-Subscriber Ã¢â‚¬â€ Plans & Packages.', href: 'cablelink_billing_faq.html#non_subs-plans-packages-question-0', keywords: 'plans internet cable offer packages non-subscriber' },
      { category: 'FAQ', title: 'Can I subscribe to internet only or cable only?', description: 'Non-Subscriber Ã¢â‚¬â€ Plans & Packages.', href: 'cablelink_billing_faq.html#non_subs-plans-packages-question-1', keywords: 'internet only cable only standalone subscribe non-subscriber plans' },
      { category: 'FAQ', title: 'Do you offer bundled packages?', description: 'Non-Subscriber Ã¢â‚¬â€ Plans & Packages.', href: 'cablelink_billing_faq.html#non_subs-plans-packages-question-2', keywords: 'bundled packages bundle cable internet non-subscriber plans' },
      { category: 'FAQ', title: 'Are there promotional offers for new subscribers?', description: 'Non-Subscriber Ã¢â‚¬â€ Plans & Packages.', href: 'cablelink_billing_faq.html#non_subs-plans-packages-question-3', keywords: 'promo promotional offers new subscribers non-subscriber plans' },

      /* Ã¢â€â‚¬Ã¢â€â‚¬ FAQ Ã¢â‚¬â€ NON-SUBSCRIBER: APPLICATION Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
      { category: 'FAQ', title: 'How do I apply for a new subscription?', description: 'Non-Subscriber Ã¢â‚¬â€ Application & Installation.', href: 'cablelink_billing_faq.html#non_subs-application-installation-question-0', keywords: 'apply new subscription application install non-subscriber' },
      { category: 'FAQ', title: 'How long does installation take?', description: 'Non-Subscriber Ã¢â‚¬â€ Application & Installation.', href: 'cablelink_billing_faq.html#non_subs-application-installation-question-1', keywords: 'installation time duration non-subscriber application' }
    ];
