...
<div class="container int-container">
	...
	<div class="text-center mainnote">
			...
			<div class="icon-container">
				<a href="<?php echo base_url().'iblaze_home'?>">
			...
			<p class="noteTest2 notemarg">SUPERCHARGED PLANS!</p>
	...
	<div class="row" id="wrapper">
			...
			<div class="picker">
				<!-- <p>Free CATV</p> -->
				<h1 style="background:#a83636;">₱888/mo</h1>
			</div>
			<div class="bottom">
				<img src="<?php echo base_url().'assets/img/icons/monitor.png'?>" class="icon">
				<div class="text-block">
				<h5>+BASIC PLUS</h5>
				<h4>(Digital Cable TV)</h4>
				</div>
			</div>
			<div class="subscribe">
				<a href="<?php echo base_url().'Subscribe?plan=supercharged&cat=internet&package=50mbps&internet=fiberlink'?>">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'Subscribe?plan=supercharged&cat=internet&package=75mbps&internet=fiberlink'?>">
					<strong>APPLY NOW!</strong>
				</a>
			</div>        	
            </div>
			...
			<div class="picker">
				<!-- <p>Free CATV</p> -->
				<h1 style="background:#2525bf;">₱1,088/mo</h1>
			</div>
			<div class="bottom">
				<img src="<?php echo base_url().'assets/img/icons/monitor.png'?>" class="icon">
				<div class="text-block">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'Subscribe?plan=supercharged&cat=internet&package=88mbps&internet=fiberlink'?>">
					<strong>APPLY NOW!</strong>
				</a>
			</div>        	
            </div>
			...
			<div class="picker">
				<!-- <p>Free CATV</p> -->
				<h1 style="background:#a83636;">₱1,388/mo</h1>
			</div>
			<div class="bottom">
				<img src="<?php echo base_url().'assets/img/icons/monitor.png'?>" class="icon">
				<div class="text-block">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'Subscribe?plan=supercharged&cat=internet&package=188mbps&internet=fiberlink'?>">
					<strong>APPLY NOW!</strong>
				</a>
			</div>        	
            </div>
			...
			<div class="picker">
				<!-- <p>Free CATV</p> -->
				<h1 style="background:#2525bf;">₱1,699/mo</h1>
			</div>
			<div class="bottom">
				<img src="<?php echo base_url().'assets/img/icons/monitor.png'?>" class="icon">
				<div class="text-block">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'Subscribe?plan=supercharged&cat=internet&package=300mbps&internet=fiberlink'?>">
					<strong>APPLY NOW!</strong>
				</a>
			</div>        	
            </div>
