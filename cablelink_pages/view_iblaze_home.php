<div class="internet">
	<div>
       <!--a href="<?php echo base_url().'promo/view_promo/6'; ?>"-->
        	<img class="hidden-xs" src="<?php echo base_url().'assets/img/carousel/DTI Web Banner Page-02.jpg' ?>" class="img-responsive unselect" style="width:100%" />
        	<img class="visible-xs" src="<?php echo base_url().'assets/img/carousel/DTI Web Banner Page-02.jpg' ?>" class="img-responsive unselect" style="width:100%" />
    	<!--/a-->
    	</div>
...
<!-- 2024 UPDATE || PIC ONLY ON TOP
<div class="container int-container">
	<div class="text-center">
    		<p class="noteTest2">Start Fast, Go Faster with I-Blaze@Home Internet Broadband</p>
		<p class="note">Get the best deals at an affordable price and know the latest updates online!</p>
   	</div>
	<div class="row" id="wrapper">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=5mbps&internet=iblaze-home'?>">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=10mbps&internet=iblaze-home'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>              	
                </div>            
			...
			<div class="pick">
				<p>Internet with Cable TV</p>
				<h1>₱588/monthly</h1>
			</div>
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=20mbps&internet=iblaze-home'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>         	
                </div>
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=40mbps&internet=iblaze-home'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>         	
                </div>
				...
				<h1 style="padding-left: 8%;">35 Mbps</h1>
			</div>
			<div class="boost">
				<p>with Free</p>
				<h1>CATV</h1>
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=100mbps&internet=iblaze-home'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>       	
                </div>
		...
		<div class="int-pkg">
                	<div class="title">
				<p style="padding-left: 8%;">UP TO</p>
				<h1 style="padding-left: 8%;">50 Mbps</h1>
			</div>
			<div class="boost">
				<p>with Free</p>
				<h1>CATV</h1>
		...
		<div class="int-pkg">
                	<div class="title">
				<p style="padding-left: 8%;">UP TO</p>
				<h1 style="padding-left: 8%;">75 Mbps</h1>
			</div>
			<div class="boost">
				<p>with Free</p>
				<h1>CATV</h1>
		...
		<div class="int-pkg">
                	<div class="title">
				<p style="padding-left: 8%;">UP TO</p>
				<h1 style="padding-left: 8%;">88 Mbps</h1>
			</div>
			<div class="boost">
				<p>with Free</p>
				<h1>CATV</h1>
		...
		<div class="int-pkg">
                	<div class="title">
				<p style="padding-left: 8%;">UP TO</p>
				<h1 style="padding-left: 8%;">120 Mbps</h1>
			</div>
			<div class="boost">
				<p>with Free</p>
				<h1>CATV</h1>
		...
		<div class="text-center">
    			<p class="noteTest1">Installation Fee - P1,000 | Lock-In Period - 24 months | 1 month Deposit | Pre-termination - P5,000</p>
   		</div>
