...
<div class="container int-container">
	...
	<div class="text-center mainnote">
    		<!-- <p class="noteTest2 notemarg">Iblazek@Home</p> -->
			<div class="icon-container">
				<a>
					<img src="<?php echo base_url().'assets/img/icons/Iblaze.png'?>" class="icon-iblaze">
				</a>
				<a href="<?php echo base_url().'Turbocharged_Fiberlink_home'?>">
	...
	<div class="row" id="wrapper">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'Subscribe?plan=turbocharged&cat=internet&package=50mbps&internet=iblaze'?>">
			...
			<div class="picker">
				<!-- <p>Free CATV</p> -->
				<h1 style="background:#2525bf;">₱1,499/mo</h1>
			</div>
			<div class="bottom">
				<img src="<?php echo base_url().'assets/img/icons/monitor.png'?>" class="icon">
				<div class="text-block">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'Subscribe?plan=turbocharged&cat=internet&package=100mbps&internet=iblaze'?>">
					<strong>APPLY NOW!</strong>
				</a>
			</div>        	
            </div>
