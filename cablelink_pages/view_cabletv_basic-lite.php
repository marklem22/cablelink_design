<div class="cabletv">
<div>
    <?php if($basic_lite_flyer['img_name_bg']!=''):?> 
   <img src="<?php echo base_url().'assets/img/cabletv/'.$basic_lite_flyer['img_name_bg'] ?>" class="img-responsive unselect" style="width:100%" />
   <!-- <img src="<?php echo base_url().'assets/img/cabletv/basic-lite-sinag.jpg' ?>" class="img-responsive unselect" style="width:100%" /> -->
   <!-- class="hidden-xs"<img class="visible-xs" src="<?php echo base_url().'assets/img/carousel/basic_mobile.jpg' ?>" class="img-responsive unselect" style="width:100%" />-->
    <?php endif;?>
</div>
<div class="container-fluid">
    <div class="row">
	<div class="cableTag">
        	<!-- <h1>Subscribe to Basic 295 CATV Plan</h1>
        ...
        <h1 class="title">BASIC <span class="orange">LITE</span> <span class="small-title">CHANNEL GUIDE</span></h1>
    	</div>
    ...
    <div class="col-sm-12 text-center" style="font-size:12px;padding:0px;">
		<p class="noteTest">TOTAL CHANNELS SD & HD = 53</p>
	</div>

    <div class="col-sm-12 text-center" style="font-size:12px;padding:0px;">
        <p class="note">CHANNEL LINE-UP AS OF JANUARY 12, 2026 </p>
    </div>
    <div class="col-sm-12 text-center" style="font-size:12px;margin-bottom:/*!5px*/ 90px;padding:0px;">
    ...
    <div class="col-sm-12 text-center" style="font-size:12px; padding:20px 0;">
        ...
        <a class="nav-btn active"> BASIC LITE</a>
    </div>
	...
	<div class="col-sm-12 text-center botNote">
		...
		<div class="row">
			<div class="col-md-6 col-sm-12">
    				<ul><li><p class="noteTest1">Initial Cash-out ₱590 1 Month advance and 1 Month deposit</p></li></ul>
   			</div>
			<div class="col-md-6 col-sm-12">
