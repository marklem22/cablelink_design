<div class="internet">
	<div>
       <!--a href="<?php echo base_url().'promo/view_promo/6'; ?>"-->
        	<!--<img class="hidden-xs" src="<?php echo base_url().'assets/img/carousel/enterprise_web.jpg' ?>" class="img-responsive unselect" style="width:100%" />
        	<img class="visible-xs" src="<?php echo base_url().'assets/img/carousel/enterprise_mobile.jpg' ?>" class="img-responsive unselect" style="width:100%" />-->
    	<!--/a-->
    	</div>
...
<div class="container int-container">
	<div class="text-center">
    		<p class="noteTest2">Start Fast, Go Faster with I-Blaze@Enterprise Internet Broadband</p>
		<p class="note">Get the right internet plan to boost your business growth!</p>
   	</div>
	<div class="row" id="wrapper">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=10mbps&internet=iblaze-enterprise'?>">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=20mbps&internet=iblaze-enterprise'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>              	
                </div>
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=30mbps&internet=iblaze-enterprise'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>         	
                </div>
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=100mbps&internet=iblaze-enterprise'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>         	
                </div>
