<div class="internet">
	<div>
       <!--a href="<?php echo base_url().'promo/view_promo/6'; ?>"-->
        	<!--<img class="hidden-xs" src="<?php echo base_url().'assets/img/carousel/fiberlink_premium_desktop.jpg' ?>" class="img-responsive unselect" style="width:100%" />
        	<img class="visible-xs" src="<?php echo base_url().'assets/img/carousel/fiberlink_premium_mobile.jpg' ?>" class="img-responsive unselect" style="width:100%" />-->
    	<!--/a-->
    	</div>
...
<div class="container int-container">
	<div class="text-center">
    		<p class="noteTest2">Start Fast, Go Faster with Fiberlink@Premium Biz Internet Broadband</p>
		<p class="note">Go beyond your Internet experience and know the latest plans updates online!</p>
   	</div>
	<div class="row" id="wrapper">
			...
			<div class="pick">
				<p>Internet and Bundled Cable TV</p>
				<h1>₱4,000/monthly</h1>
			</div>
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=10mbps&internet=fiberlink-premium'?>">
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=20mbps&internet=fiberlink-premium'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>              	
                </div>
			...
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=40mbps&internet=fiberlink-premium'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>       	
                </div>
			...
			<div class="pick">
				<p>Internet and Bundled Cable TV</p>
				<h1>₱12,000/monthly</h1>
			</div>
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=60mbps&internet=fiberlink-premium'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>         	
                </div>
		...
		<div class="int-pkg">
			...
			<div class="pick">
				<p>Internet and Bundled Cable TV</p>
				<h1>₱15,000/monthly</h1>
			</div>
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=80mbps&internet=fiberlink-premium'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>         	
                </div>
		...
		<div class="int-pkg">
			...
			<div class="pick">
				<p>Internet and Bundled Cable TV</p>
				<h1>₱18,000/monthly</h1>
			</div>
			<div class="subscribe">
				<a href="<?php echo base_url().'subscribe?cat=internet&package=100mbps&internet=fiberlink-premium'?>">
					<strong>SUBSCRIBE</strong>
				</a>
			</div>           	
                </div>
